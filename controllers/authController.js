...
exports.enviarToken = async (req,res)=>{
    ...
    usuario.token = crypyto.randomBytes(20).toString('hex');
...
//Validar el token y el usuario exista
...
//Almacena el nuevo password en la BBDD
...
exports.guardarPassword = async (req,res)=>{
    ...
    //No existe usuario o token inválido
